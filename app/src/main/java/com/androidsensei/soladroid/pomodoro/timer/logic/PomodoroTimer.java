...
public class PomodoroTimer {
    ...
    /**
     * The current countdownTime of this Pomodoro timer - can be initialized, paused, stopped or running.
     */
    ...
    /**
     * @return true if the current timer countdownTime is initialized, false otherwise.
     */
